...
********************/
		...
		$wp_customize->add_setting( 'new_york_business_option[social_vk_link]' , array(
		'default'    => '',
		'sanitize_callback' => 'esc_url_raw',
		'type'=>'option'
		));

		$wp_customize->add_control('new_york_business_option[social_vk_link]' , array(
		'label' => __('VK Link','new-york-business' ),
		'section' => 'social_section',
		'type'=>'url',
		) );

		$wp_customize->add_setting( 'new_york_business_option[social_instagram_link]' , array(
		'default'    => '',
		'sanitize_callback' => 'esc_url_raw',
		'type'=>'option'
		));

		$wp_customize->add_control('new_york_business_option[social_instagram_link]' , array(
		'label' => __('Instagram Link','new-york-business' ),
		'section' => 'social_section',
		'type'=>'url',
		) );
