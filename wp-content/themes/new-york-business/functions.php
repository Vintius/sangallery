...
if ( isset( $_GET['new_york_business_notice_dismissed'] ) ){
	update_option('new_york_business_help_notice', -1);
}

$new_york_business_help_notice = get_option('new_york_business_help_notice', true);
if($new_york_business_help_notice > 0){
